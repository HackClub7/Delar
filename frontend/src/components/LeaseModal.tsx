...
//   setIsOpen: (isOpen: boolean) => void; // To toggle the modal
//   onConfirm: (landIndex: number, landPortion: number) => void; // Confirm action handler
// }
...
//     onConfirm(landIndex, landPortion); // Trigger the confirm action
//   };
...
//                   className="w-full lg:w-auto md:px-8 md:text-base text-sm md:py-3 bg- px-6 py-1  rounded-lg bg-[#5C4033] text-white font-bold shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300 ease-in-out"
//                 >
//                   Cancel
//                 </button>
