...
const Home = () => {
  return (
    <div className="flex flex-col lg:flex-row md:justify-center items-center mt-6 md:mt-0 w-full min-h-screen text-white p-4 lg:p-8">
      <div className="lg:w-1/2 w-full lg:pr-8">
        ...
        <div className="flex flex-row items-center align-middle lg:items-center gap-4 mt-10 md:mt-16 ">
          <Link to={"/buyersPage"}>
          ...
          <img src={button} alt="" className="block w-28 h-auto" />
          <Link to={"/register"}>
            <button className="w-full lg:w-auto px-8 py-3 rounded-lg bg-gradient-to-r from-green-400 via-green-500 to-green-600 text-white font-bold shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300 ease-in-out ">
              Sell Land
            </button>
      ...
      <div className="lg:w-3/5 w-full mt-8 lg:mt-0">
        {/* land display for mobile view */}
        <div className="hidden relative lg:grid-cols-2 md:grid  grid-cols-1 md:grid-cols-2 gap-4">
          <img
            src={landcover}
            alt="Land Cover"
